 ...
 * =============================================================================
 */
//trying to install so import will work - getting error:
//sudo npm install @tensorflow/tfjs-node
/*
npm ERR! While resolving: @tensorflow-models/qna@1.0.1
npm ERR! Found: rollup@2.38.5
npm ERR! node_modules/rollup
npm ERR!   dev rollup@"~2.38.0" from the root project
npm ERR! 
npm ERR! Could not resolve dependency:
npm ERR! peer rollup@"^1.20.0" from @rollup/plugin-typescript@3.1.1
npm ERR! node_modules/@rollup/plugin-typescript
npm ERR!   dev @rollup/plugin-typescript@"3.1.1" from the root project
*/
